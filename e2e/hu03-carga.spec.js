...
test('HU-03 · el Temporal sube directo al almacén y aparece en la carpeta con su cuota', async ({ page, request }) => {
  ...
  // RI-06: el binario viajó por PUT al almacén (URL prefirmada; Playwright no expone el cuerpo de un File, el tamaño
  // exacto lo comprueba la custodia al confirmar) y ninguna llamada a la custodia lo llevó.
